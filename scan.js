...
const SKIP_RANGES = new Set(['marble-carvings', 'marble-handicrafts', 'indian-italian-marble', 'travertin', 'travertine']);
...
const ROMAN_NUMERAL_RANGES = new Set(['indian-italian-marble', 'travertin', 'travertine']);
...
// (no colour subfolders): travertin, indian-italian-marble, etc.
//
...
function buildCatalog() {
  ...
  for (const rangeFolder of rangeFolders) {
    ...
    // ── Special: Roman-numeral flat ranges (travertin, indian-italian-marble, …) ──
